...
type LogServiceClient interface {
	WriteLog(ctx context.Context, in *LogRequet, opts ...grpc.CallOption) (*LogResponse, error)
}
...
func (c *logServiceClient) WriteLog(ctx context.Context, in *LogRequet, opts ...grpc.CallOption) (*LogResponse, error) {
	out := new(LogResponse)
...
type LogServiceServer interface {
	WriteLog(context.Context, *LogRequet) (*LogResponse, error)
...
func (UnimplementedLogServiceServer) WriteLog(context.Context, *LogRequet) (*LogResponse, error) {
...
func _LogService_WriteLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).WriteLog(ctx, req.(*LogRequet))
	}
