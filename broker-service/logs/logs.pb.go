...
func (x *LogRequet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LogRequet) ProtoMessage() {}

func (x *LogRequet) ProtoReflect() protoreflect.Message {
	mi := &file_logs_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LogRequet.ProtoReflect.Descriptor instead.
func (*LogRequet) Descriptor() ([]byte, []int) {
	return file_logs_proto_rawDescGZIP(), []int{1}
}

func (x *LogRequet) GetLogEntry() *Log {
	if x != nil {
		return x.LogEntry
	}
	return nil
...
var file_logs_proto_rawDesc = []byte{
	...
	0x61, 0x22, 0x32, 0x0a, 0x09, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x74, 0x12, 0x25,
	0x0a, 0x08, 0x6c, 0x6f, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x09, 0x2e, 0x6c, 0x6f, 0x67, 0x73, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x08, 0x6c, 0x6f, 0x67,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x25, 0x0a, 0x0b, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70,
	...
	0x69, 0x74, 0x65, 0x4c, 0x6f, 0x67, 0x12, 0x0f, 0x2e, 0x6c, 0x6f, 0x67, 0x73, 0x2e, 0x4c, 0x6f,
	0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x74, 0x1a, 0x11, 0x2e, 0x6c, 0x6f, 0x67, 0x73, 0x2e, 0x4c,
	0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x6c,
...
var file_logs_proto_goTypes = []interface{}{
	(*Log)(nil),         // 0: logs.Log
	(*LogRequet)(nil),   // 1: logs.LogRequet
	(*LogResponse)(nil), // 2: logs.LogResponse
}
var file_logs_proto_depIdxs = []int32{
	0, // 0: logs.LogRequet.logEntry:type_name -> logs.Log
	1, // 1: logs.LogService.WriteLog:input_type -> logs.LogRequet
